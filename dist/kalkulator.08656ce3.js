...
},{}],"node_modules/vue-slide-bar/dist/vue-slide-bar.min.js":[function(require,module,exports) {
var define;
/*!
 ...
 */
!function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.vueSlideBar = e();
}(this, function () {
  "use strict";
  ...
  return function () {
    ...
    watch: {
      value: function (t) {
        this.flag ? this.setValue(t) : this.setValue(t, this.speed);
      },
      max: function (t) {
        if (t < this.min) return this.printError("[VueSlideBar error]: The maximum value can not be less than the minimum value.");
        var e = this.limitValue(this.val);
        this.setValue(e), this.refresh();
      },
      min: function (t) {
        if (t > this.max) return this.printError("[VueSlideBar error]: The minimum value can not be greater than the maximum value.");
        var e = this.limitValue(this.val);
        this.setValue(e), this.refresh();
      }
    },
    methods: {
      ...
      getPos: function (t) {
        return this.realTime && this.getStaticData(), t.clientX - this.offset;
      },
      wrapClick: function (t) {
        if (this.isDisabled || !this.draggable && "wrap" === t.target.id) return !1;
        var e = this.getPos(t);
      ...
      setCurrentValue: function (t, e) {
        ...
        this.isDiff(this.currentValue, t) && (this.currentValue = t, this.lazy && this.flag || this.syncValue()), e || this.setPosition();
      },
      setIndex: function (t) {
        t = this.spacing * t + this.minimum, this.setCurrentValue(t);
      },
      setValue: function (t, e) {
        var i = this;

        if (this.isDiff(this.val, t)) {
          var s = this.limitValue(t);
          this.val = s, this.syncValue();
        }

        this.$nextTick(function () {
          return i.setPosition(e);
        });
      },
      setPosition: function (t) {
        this.flag ? this.setTransitionTime(0) : this.setTransitionTime(void 0 === t ? this.speed : t), this.setTransform(this.position);
      },
      setTransform: function (t) {
        var e = "translateX(" + (t - (this.$refs.tooltip.scrollWidth - 2) / 2) + "px)";
        this.slider.style.transform = e, this.slider.style.WebkitTransform = e, this.slider.style.msTransform = e, this.$refs.process.style.width = t + "px", this.$refs.process.style.left = 0;
      },
      setTransitionTime: function (t) {
        this.slider.style.transitionDuration = t + "s", this.slider.style.WebkitTransitionDuration = t + "s", this.$refs.process.style.transitionDuration = t + "s", this.$refs.process.style.WebkitTransitionDuration = t + "s";
      },
      limitValue: function (t) {
        var e = this;
        if (this.data) return t;
        var i;
        return (i = t) < e.min ? (e.printError("[VueSlideBar warn]: The value of the slider is " + t + ", the minimum value is " + e.min + ", the value of this slider can not be less than the minimum value"), e.min) : i > e.max ? (e.printError("[VueSlideBar warn]: The value of the slider is " + t + ", the maximum value is " + e.max + ", the value of this slider can not be greater than the maximum value"), e.max) : i;
      },
      syncValue: function () {
        var t = this.val;
        this.range && this.$emit("callbackRange", this.range[this.currentIndex]), this.$emit("input", t);
      },
      getValue: function () {
        return this.val;
      },
    ...
    mounted: function () {
      ...
      this.$nextTick(function () {
        t.isComponentExists && (t.getStaticData(), t.setValue(t.limitValue(t.value), 0), t.bindEvents());
      });
    },
...
},{}],"src/kalkulator.vue":[function(require,module,exports) {
"use strict";
...
var _vueSlideBar = _interopRequireDefault(require("vue-slide-bar"));
...
var _default = {
  ...
  methods: {},
  components: {
    VueSlideBar: _vueSlideBar.default
  },
  computed: {
    interestValue: function interestValue() {
      if (this.money <= 5000) {
    ...
    commissionValue: function commissionValue() {
      if (this.money >= 500 && this.money <= 5000 && this.time >= 3 && this.time <= 96) {
        return this.commissionValue = 6.99;
      } else if (this.money > 5000 && this.money <= 15000 && this.time >= 3 && this.time <= 96) {
        return this.commissionValue = 6.49;
      } else if (this.money > 15000 && this.money <= 30000 && this.time >= 3 && this.time <= 96) {
...
exports.default = _default;
        var $a6cdec = exports.default || module.exports;
      
      if (typeof $a6cdec === 'function') {
        $a6cdec = $a6cdec.options;
      }
    
        /* template */
        Object.assign($a6cdec, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "mbank-app" } }, [
    _c("div", { staticStyle: { height: "100px", width: "auto" } }),
    _vm._v(" "),
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-sm-7" }, [
          _c("h1", { staticClass: "app-header" }, [
            _vm._v("Pierwszy kredyt gotówkowy")
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "moneyNeeded" }, [
            _vm._v("\n          Ile pieniędzy potrzebujesz?\n          "),
            _c("span", [
              _vm._v(_vm._s(Math.round(_vm.money / 100) * 100) + " zl")
            ])
          ]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "moneyValue" },
            [
              _c("VueSlideBar", {
                attrs: { min: 500, max: 150000, range: _vm.sliderMoney.range },
                scopedSlots: _vm._u([
                  {
                    key: "tooltip",
                    fn: function(tooltip) {
                      return [
                        _c("img", {
                          ...
                          attrs: {
                            src:
                              "https://s3-eu-west-1.amazonaws.com/landingi-editor-uploads/cmacn0ZG/arrow.png"
                          }
                        })
                      ]
                    }
          ...
          _vm._v(" "),
          _c("div", { staticClass: "timeNeeded" }, [
            _vm._v("\n          W jakim czasie chcesz spłacić?\n          "),
            _c("span", [_vm._v(_vm._s(_vm.time) + " mies.")])
          ]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "timeValue" },
            [
              _c("VueSlideBar", {
                attrs: { min: 3, max: 120, range: _vm.sliderTime.range },
                scopedSlots: _vm._u([
                  {
                    key: "tooltip",
                    fn: function(tooltip) {
          ...
          _vm._v(" "),
          _c("div", { attrs: { id: "insurance-checkbox" } }, [
        ...
        _c("div", { staticClass: "col-sm-5" }, [
          ...
          _c("br"),
          _vm._v(" "),
          _c("h4", { staticClass: "monthlyRate" }, [
            _vm._v("\n          Miesięczna rata:\n          "),
            _c("span", { staticClass: "monthlyValue" }, [
              _vm._v(_vm._s(Math.round(_vm.money / _vm.time)) + " zl")
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "totalCost" }, [
            _c("div", { staticClass: "intValue" }, [
              _vm._v(
                "\n            Oprocentowanie nominalne w skali roku:\n            "
              ),
              _c("span", [_vm._v(_vm._s(_vm.interestValue) + "%")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "commValue" }, [
              _vm._v("\n            Prowizja:\n            "),
              _c("span", [_vm._v(_vm._s(_vm.commissionValue) + "%")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "loanValue" }, [
              _vm._v("\n            Calkowity koszt kredytu:\n            "),
              _c("span", [
                _vm._v(
                  _vm._s(Math.round(_vm.money * (_vm.interestValue / 100))) +
                    " zł"
                )
              ])
            ]),
            _vm._v(" "),
            _vm.checked
              ? _c("div", { staticClass: "insValue" }, [
                  _vm._v(
                    "\n            Miesięczna składka ubezpieczeniowa:\n            "
                  ),
                  _c("span", [_vm._v(_vm._s(_vm.insuranceValue) + "%")])
                ])
              : _vm._e()
          ]),
          _vm._v(" "),
          _c("br"),
          _vm._v(" "),
          _c("div", { staticClass: "rrsoValue" }, [
            _vm._v("\n          RRSO:\n          "),
            _c("span", [
              _vm._v(_vm._s(Math.round(_vm.money / _vm.time) / 100) + "%")
            ]),
            _vm._v(" "),
            _c("br"),
            _vm._v(" "),
            _c(
              "button",
              { staticClass: "btn", attrs: { type: "button", name: "button" } },
              [_vm._v("ZŁÓŻ WNIOSEK")]
            )
          ])
        ])
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("span", { staticClass: "loanTooltip" }, [
        _vm._v("Zobacz koszt kredytu")
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a6cdec', $a6cdec);
          } else {
            api.reload('$a6cdec', $a6cdec);
          }
        }
...
},{"vue-slide-bar":"node_modules/vue-slide-bar/dist/vue-slide-bar.min.js","_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/kalkulator.js":[function(require,module,exports) {
"use strict";

var _vue = _interopRequireDefault(require("vue"));

var _kalkulator = _interopRequireDefault(require("./kalkulator.vue"));

var _vueSlideBar = _interopRequireDefault(require("vue-slide-bar"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue.default.component('vue-slide-bar', _vueSlideBar.default);

new _vue.default({
  el: '#mbank-app',
  render: function render(h) {
    return h(_kalkulator.default);
  }
});
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./kalkulator.vue":"src/kalkulator.vue","vue-slide-bar":"node_modules/vue-slide-bar/dist/vue-slide-bar.min.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/kalkulator.js"], null)
//# sourceMappingURL=/kalkulator.08656ce3.map